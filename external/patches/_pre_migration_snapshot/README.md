...
> **2026-08-22 起 `requirements-rt.txt` 上表那一栏不再等于工作区现值。** 经用户批准往
> `envs/requirements-rt.txt` 追加了 `pyarrow==25.0.1`（LeRobot v3.0 导出要写 parquet，
> 见 `docs/BACKLOG.md` B10），加注释共 +4 行，md5
> `e8f9e2f7da81ef6325e09585d8000ef5` → `841a67ed2ed2fff30879954f2e619c2d`。
> 上表记录的是 **8/06 备份当时**的状态，保持原值不改 —— 它是历史存档，不是活基线。
